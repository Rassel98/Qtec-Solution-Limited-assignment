...
//         bookingPrice:int.parse(json["booking_price"]) ,
//         currentCharge: int.parse(json["current_charge"]),
//         discountCharge: int.parse(json["discount_charge"]),
//         sellingPrice: int.parse(json["selling_price"]),
